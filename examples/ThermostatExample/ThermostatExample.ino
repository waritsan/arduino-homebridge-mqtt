/*
	...
	This thermostat example shows how to read a temperature with Dallas temperature sensor attached to 
  pin D1 and sends the value to Homebridge MQTT server. You can control the thermostat operation from
  the Home app.
